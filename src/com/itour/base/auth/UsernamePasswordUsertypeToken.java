...
public class UsernamePasswordUsertypeToken implements HostAuthenticationToken, RememberMeAuthenticationToken {
    ...
    * @param usertype 用户类型
    */
   public UsernamePasswordUsertypeToken(final String username, final char[] password,final boolean rememberMe, final String host, final String usertype) {
    ...
    * @param usertype 用户类型
    */
   public UsernamePasswordUsertypeToken(final String username, final String password,final boolean rememberMe, final String host, final String usertype) {
