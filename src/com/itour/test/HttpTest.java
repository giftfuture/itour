...
import com.itour.base.util.Base64;
...
//        doTest2();
    ...
    private static void doTest1() {
        try {
            ...
            if (code == 200) {
                ...
                //解析返回的json
                JSONObject jObj = JSONObject.parseObject(jsonResult);
                ...
                if (conn.getResponseCode() == 200) {
                    ...
                    System.out.println(jsonResult);
                    JSONArray array = JSONObject.parseObject(jsonResult).getJSONObject("Response").getJSONObject("business").getJSONArray("businessList");
                    for (int i = 0; i < array.size(); i++) {
                        System.out.println(" id:" + array.getJSONObject(i).getIntValue("businessId"));
    ...
    private static void doTest3() {
        ...
        String encodedToken = "Basic "+Base64.encodeBase64("zongcai:111111".getBytes());
    ...
    private static void doTest2() throws JSONException {
        ...
        if (loginResponse.getStatusCode() == HttpStatus.OK) {
            ...
            if (loginResponse.getStatusCode() == HttpStatus.OK) {
                JSONArray array = JSONObject.parseObject(loginResponse.getBody()).getJSONObject("Response").getJSONObject("business").getJSONArray("businessList");
                for (int i = 0; i < array.size(); i++) {
                    System.out.println(" id:" + array.getJSONObject(i).getIntValue("businessId"));
                    System.out.println(" name:" + array.getJSONObject(i).getString("businessName"));
                    System.out.println(" desc:" + array.getJSONObject(i).getString("businessDesc"));
