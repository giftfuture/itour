$package('itour.msearchRt');
itour.msearchRt = function(){
	var _this = {
			  ...
			  //  console.log(travel_style+"  "+vacation+"   "+areas);
				...
				function(responseText){
						...
						$(searchRts).each(function(i,e){
			                ...
			                '<tr><td width="34%" class="f12-gao1"><a href="'+basePath+e.travelStyleAlias+'/'+e.travelStyleAlias+'/'+e.alias+'">【'+(e.travelStyleType?e.travelStyleType:"")+'】'+(e.title?e.title:"")+'</a></td>'+
			              '</tr></table></td>';
						});
						$("#fbcontent").html("");
