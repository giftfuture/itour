  ...
  <tr>
    ...
    <td class="rightlinks"><table width="960" border="0" align="center" cellpadding="0" cellspacing="0" class="lefttxt">
      ...
      <table width="960" border="0" align="center" cellpadding="0" cellspacing="5">
        <tr> 
          <td> <h1> Trekking from Mt Siguniang to Bipeng Valley </h1></td>
        </tr>
      </table>
      <table width="960" border="0" align="center" cellpadding="0" cellspacing="10" bgcolor="#CCCCCC" class="lefttxt">

        <tr>
          <td width="600" valign="top"><img src="img-test/girl-1.jpg" width="600" height="338" /></td>
          <td width="330" valign="middle"><p class="STYLE126"><span class="STYLE129"><strong>Features</strong>£º</span><br />
              <strong>* Climb a snow mountain of 5000 meters high. <br />
              *  One of the most amazing trekking routines in China. <br />
              * Experience the Tibetan and Qiang ethnic culture. <br />
              * Flowers blooming in May and June,  Cloful autumn in September and October. <br />
              </strong></p>
            <p class="STYLE126"><span class="STYLE129">Days£º</span> 10 days (trekking 7 days£¬Can be changed to 8-20 days&nbsp;)¡¡¡¡<span class="STYLE129"><br />
Difficulty degree£º</span>***-- ¡¡¡¡¡¡¡¡<br />
<span class="STYLE129">Highest Altitude£º</span> 4600 meters<span class="STYLE129"><br />
Seasons£º</span>May--Oct<br />
<span class="STYLE129">Number of travelers  £º</span>2 or more people can make a private customized tour. </p>
          <p class="right"><span class="rightlinks"><a href="http://www.itours.com.cn/booking/booking-swca.php">Reservation</a>&gt;&gt;</span></p></td>
        </tr>
      </table>
      <table width="960" border="0" align="center" cellpadding="0" cellspacing="10" class="lefttxt">
        <tr> 
          <td width="620" valign="top"><p> Trekking from Mt Siguniang to Bipeng Valley</p>
            <p>Mt. Siguniang area is a stunning 4 peaked mountain ranges (the highest 6250 m) in the North West of Sichuan. It is possible to join tours to climb the 1st and 2nd peaks, but the 3rd and 4th are serious mountaineering expeditions. The local culture is predominantly Tibetan .<br />
              The Changping to Bipeng Valley Trek is one of the most classic hikes through the scenic Mt. Siguniang mountain range. The group will need to be self-sufficient for two and a half days to ascend the Changping Valley to the 4668m pass and descend down into the Bipeng valley and along to the road head the end of the hike. In the Changping Valley your group will be supported by pack horses but the hike over pass is too step and narrow for horses, so a team of porters will help transport the groups gear into the Bipeng Valley until pack horses can be used at the other side. The last 3km of the walk will be unsupported.<br />
              During the tour you will experience the stunning scenery of the Mt Siguniang area and experience the kindness of the local minority Tibetan people and its cultures.</p>
            <p>HIGHLIGHTS:
              Mount SiGuNiang, HaiZi valley,Bipeng Valley <br />
              <br />
              <span class="right">Itinerary£º</span><br />
              D1 Arrive in Chengdu <br />
              D2 Chengdu -- Dujiangyan --Rilong town by driving <br />
              D3 Hiking in Haizi Valley <br />
              D4 Climb to the camp of the second peak. (Camp) <br />
              D5 To the top of the mountain. Back to Rilong town. <br />
              D6 Rilong town -- Lama temple -- blasted tree ¡ª Muluozi <br />
              D7 Muluozi¡ª¡ªShuidaba ¡ª¡ªChazi Valley Camp <br />
              D8 Chazi Valley¡ªMountain Pass¡ªBipeng Valley ¡ªLixian county <br />
              D9  Lixian county ¡ª¡ªWenchuan ¡ªChengdu <br />
            D10 Farewell<br />
            <br />
                <strong>*The above itinerary is for your reference and it can be flexibly changed according to your specific request.</strong><br />
                <span class="rightlinks"><a href="http://www.itours.com.cn/booking/booking-swca.php"><strong><br /></strong>Reservation</a>&gt;&gt;</span><br />
              <br />
              <img src="img-test/girl-02.jpeg" width="600" height="399" /><br />
              <br />
              <img src="img-test/girl-03.jpeg" width="600" height="399" /><br />
              <br />
              <br />
              <img src="img-test/girl-04.jpeg" width="600" height="399" /><br />
              <br />
              <br />
            </p>
          </td>
          <td valign="top">Map£º<br />
