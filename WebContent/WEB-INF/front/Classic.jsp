...
<table width="996" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td class="rightlinks"><table width="960" border="0" align="center" cellpadding="0" cellspacing="0" class="lefttxt">
      ...
      <table width="848" border="0" align="center" cellpadding="0" cellspacing="5">
        <tr> 
          <td width="815" colspan="2"> <h1 class="STYLE132">Classic tour  in Sothwest China</h1></td>
        </tr>
        <tr>
          <td colspan="2"><br />
              <br />
            <br />
            <span class="STYLE135">Sichuan | Yunnan | Tibet <br />
            <br />
          </span></td>
        </tr>
      </table>
      <table width="848" border="0" align="center" cellspacing="5">
        <tr>
          <td width="109"><img src="img-test/Classic/Sichuan/hl01.jpg" width="300" height="169" /></td>
          <td width="729"><p><span class="STYLE132">Chengdu / Jiuzhaigou / Mt.Emei-Leshan Tour 8 days¡¡ ¡¡</span>¡¡¡¡¡¡¡¡¡¡¡¡¡¡ <br />
              <span class="STYLE130">*</span><br />
          <span class="STYLE131">¡·¡·<a href="classic-sichuan01.html">More</a></span></p>          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
