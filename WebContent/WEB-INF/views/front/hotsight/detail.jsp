    ...
    <table border="0" cellpadding="2" cellspacing="0" class="f12-gao1">
      <tr>
        ...
        <tr><td>相关路线：
            ...
            <a href="${basePath}hotsight/hotsight/${relat.alias}" class="easyui-linkbutton" >${relat.title }</a>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <table width="600" border="0" cellspacing="0" cellpadding="0">
   <tbody><tr>
     ...
     <td width="264"><span class="STYLE3" ><a href="${basePath}hotsight/selfbooking/${rt.alias}">
