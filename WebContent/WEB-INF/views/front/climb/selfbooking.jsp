    ...
    <td> <div align="center"> </div>
      ...
      <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="heedline1">
		...
		<tr> 
		  ...
		  出团日期：<input id="groupDate" name="groupDate" type="text" class='easyui-datebox' data-options="validType:'dateValided',editable:false,split:true,border:false,region:'north',onSelect:itour.climbselfbooking.onChangeDate(this)" style="width:100px;" />
		  </span> </td>
        </tr>
        <tr> 
