    ...
    <td> <div align="center"> </div>
      ...
      <table width="80%" border="0" align="center" cellpadding="2" cellspacing="0" class="heedline1">
        ...
        <tr> 
          ...
          <td style="text-align:left"><input name="expectedDepart" id="expectedDepart" type="text" class='easyui-datetimebox' data-options="validType:'dateValided',editable:false,required:true,split:true,border:false,region:'north',onSelect:itour.climbselfbooking.onChangeDate(this)" style="width:150px;" /></td>
        </tr>
        <tr> 
          <td><div align="right"><strong>预计返程日期：</strong></div></td>
          <td style="text-align:left"><input id="expectedBack" name="expectedBack" type="text" class='easyui-datetimebox' data-options="validType:'md[\'#expectedDepart\']',editable:false,required:true,split:true,border:false,region:'north',onSelect:itour.climbselfbooking.onChangeDate(this)" style="width:150px;" />
            </td>
        </tr>
		<tr> 
