    ...
    <td> <div align="center"> </div>
      ...
      <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="heedline1">
        <tr> 
         ...
         <%--  <input name="routename" type="text" class="easyui-textbox" data-options="editable:false" size="80" value="${rt.title } " /> --%>
          </td>
        </tr>
        <tr> 
          <td><div align="right"><strong>预计出行日期：</strong></div></td>
          <td style="text-align:left"><input name="expectedDepart" id="expectedDepart" type="text" class='easyui-datebox' data-options="showSeconds:false, validType:'dateValided',editable:false,split:true,border:false,region:'north',onSelect:itour.lightselfbooking.onChangeDate(this)" style="width:150px;" /></td>
        </tr>
        <tr> 
          <td><div align="right"><strong>预计返程日期：</strong></div></td>
          <td style="text-align:left"><input id="expectedBack" name="expectedBack" type="text" class='easyui-datebox' data-options="showSeconds:false, validType:'md[\'#expectedDepart\']',editable:false,split:true,border:false,region:'north',onSelect:itour.lightselfbooking.onChangeDate(this)" style="width:150px;" />
            </td>
        </tr>
		<tr> 
		...
		<!--   团号:<input id="groupCode" type="text" class="easyui-textbox" size="80" /> -->
		  出团日期：<input id="groupDate" name="groupDate" type="text" class='easyui-datebox' data-options="validType:'dateValided',editable:false,split:true,border:false,region:'north',onSelect:itour.lightselfbooking.onChangeDate(this)" style="width:100px;" />
		  </span> </td>
        </tr>
        <tr> 
...
<!--         <tr> 
  ...
  <!--  <tr> 
    ...
    <tr> 
      ...
      <tr> <td></td>
          <td style="text-align:left;padding-bottom:50px;"><a class="easyui-linkbutton"  iconcls="icon-ok" name="check_formbtn">快速预定</a></td>
      </tr>
      </table></td>
