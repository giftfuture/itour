...
<div class="commontb" id="tab-container" class='tab-container' border="0" cellpadding="3" cellspacing="1">
 ...
 <div id="review">
  ...
  <div id="detail-route">
   <table  class="commontb" border="0" align="center" cellpadding="5" cellspacing="0">
   <%--  <tr>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr><td colspan="2"><span class="STYLE7">注：以上行程僅供參考，可根据您的假期重新调整设计。</span></td> </tr>
  ...
  <table  class="commontb" border="0" cellspacing="0" cellpadding="0">
   <tbody><tr>
     <td width="336"><span class="STYLE3">告诉我们您的需求，免费为您策划方案 GO! </span></td>
     <td width="264"><span class="STYLE3" ><a href="${basePath}light/selfbooking/${rt.alias}">
        ...
        <tr>
          <td width="327" valign="top"><table width="303" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
              ...
              <tr>
                ...
                <td width="249" bgcolor="#F0F0F0" class="STYLE126"><input type="text" name="name"  class="easyui-textbox" data-options="required:true,validType:'string'"/><!--  -->
