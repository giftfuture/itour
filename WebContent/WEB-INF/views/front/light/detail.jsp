...
<table width="1140" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr><td colspan="2" style="text-align:left"><span class="STYLE7">注：以上行程僅供參考，可根据您的假期重新调整设计。</span></td> </tr>
  ...
  <table  class="frametb" border="0" cellspacing="0" cellpadding="0">
   <tbody><tr>
     <td width="336"><span class="STYLE3" style="text-align:left">告诉我们您的需求，免费为您策划方案 GO! </span></td>
     <td width="264" style="text-align:left"><span class="STYLE3" ><a href="${basePath}light/selfbooking/${rt.alias}">
