    ...
    <td> <div align="center"> </div>
      ...
      <table width="80%" border="0" align="center" cellpadding="2" cellspacing="0" class="heedline1">
        <tr> 
          ...
          <td width="81%" style="text-align:left"><input name="routename" type="text" size="80" value="${rt.title } " /></td>
        </tr>
        <tr> 
          <td><div align="right"><strong>预计出行日期：</strong></div></td>
          <td style="text-align:left"><input name="expectedDepart" type="text" class='easyui-datebox' data-options="validType:'dateValided',editable:false,required:true,split:true,border:false,region:'north',onSelect:itour.selfdriveselfbooking.onChangeDate(this)" style="width:100px;" /></td>
        </tr>
        <tr> 
          <td><div align="right"><strong>预计返程日期：</strong></div></td>
          <td style="text-align:left"><input name="expectedBack" type="text" class='easyui-datebox' data-options="validType:'dateValided',editable:false,required:true,split:true,border:false,region:'north',onSelect:itour.selfdriveselfbooking.onChangeDate(this)" style="width:100px;" />
            </td>
        </tr>
		<tr> 
          <td><div align="right"><strong>旅行方式：</strong></div></td>
          <td style="text-align:left"><select name="travelfashion" type="text">
        ...
        <tr> 
          <td valign="top"> <div align="right"><strong>行程要求：<br />
              （复选） </strong></div></td>
          <td style="text-align:left"> <input name="travelrequest[]" type="checkbox" value="摄影为主" />
            摄影为主 
            ...
            会议奖励<br /> <input name="travelrequest[]" type="checkbox" value="紧凑" />
            紧凑 
            <input name="travelrequest[]" type="checkbox" value="舒适轻松" />
            舒适轻松 <br /> <input name="travelrequest[]" type="checkbox" value="自驾" />
            自驾 
            <input name="travelrequest[]" type="checkbox" value="摩托" />
            摩托 
            <input name="travelrequest[]" type="checkbox" value="徒步" />
            徒步<br /> <input name="travelrequest[]" type="checkbox" value="不购物" />
            不购物 </td>
        </tr>
        <tr>
        ...
        <tr> 
          ...
          <td style="text-align:left"><input type="radio" name="guide" value="中文" />
            中文 
            <input type="radio" name="guide" value="英文" />
            英文 
            <input type="radio" name="guide" value="广东话" />
            广东话 
            <input type="radio" name="guide" value="其他语种" />
            其它语种：<input type="text" name="guide_other" id="guide_other" value=""> 
            <input type="radio" name="guide" value="无需导游" />
            无需导游 </td>
        </tr>
        <tr> 
...
<!--         <tr> 
        ...
        <tr> 
          ...
          <td style="text-align:left"><input name="receiver" type="text" /> 
          <select name="gender">
              <option>性别</option>
        ...
        <tr> 
          ...
          <td style="text-align:left"><input name="adults" size="6" type="number" min=0 class="easyui-numberbox,easyui-validatebox" data-options="groupSeparator:',',width:151,height:22" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onafterpaste="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)"/>
            大人 
            <input name="children" size="6" type="number" min=0 class="easyui-numberbox,easyui-validatebox" data-options="precision:0,groupSeparator:',',width:151,height:22 " onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onafterpaste="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" />
            小孩（12岁以下） </td>
        </tr>
        <tr> 
          <td><div align="right"><strong>国家及地区：</strong></div></td>
          <td style="text-align:left"><input name="comefrom" type="text" />
            （如：中国香港）</td>
        </tr>
        <tr> 
          <td><div align="right"><strong>E-mail：</strong></div></td>
          <td style="text-align:left"><input name="receiveremail" type="text" /> </td>
        </tr>
        <tr> 
          <td><div align="right"><strong>联系电话：</strong></div></td>
          <td style="text-align:left"><input name="receiverMobile" type="text"  size="6" type="number" min=0 class="easyui-numberbox,easyui-validatebox" data-options="groupSeparator:',',width:151,height:22" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onafterpaste="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)"/></td>
        </tr>
   <!--      <tr> 
        ...
        <tr> 
          ...
          <td width="81%" valign="top" style="text-align:left"><label>特色酒店： 
            ...
            交通方便 <br />
            房型要求：双床房 
            <input name="db_room"  size="6" type="number" min=0 class="easyui-numberbox,easyui-validatebox" data-options="groupSeparator:',',width:51,height:22" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onafterpaste="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)"/>
            间 大床房 
            <input name="bb_room"  size="6" type="number" min=0 class="easyui-numberbox,easyui-validatebox" data-options="groupSeparator:',',width:51,height:22" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onafterpaste="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" />
            间 套房<input name="suite"  size="6" type="number" min=0 class="easyui-numberbox,easyui-validatebox" data-options="groupSeparator:',',width:51,height:22" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onafterpaste="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)"/>
            间 备：<br />
            ...
            希望能得到确定后酒店的资料<br />
            若有您喜欢的酒店可在个性需求里面填写 </label></td>
        </tr>
        <tr><td></td><td></td></tr>
        <tr> 
          <td valign="top"><div align="right"><strong>交通：<br />
              </strong></div></td>
          <td valign="top" style="text-align:left">飞机： 
            <input name="plane[]" type="checkbox" value="中国国内" />
            中国国内 
            <input name="plane[]" type="checkbox" value="国际" />
            国际<br />
            舱位： 
        ...
        <tr> 
          ...
          <td valign="top" style="text-align:left"><input type="radio" name="tickets" value="仅大门票" />
            仅大门票 
        ...
        <tr> 
          ...
          <td valign="top" style="text-align:left">特色： 
            ...
            火锅 其它： 
            <input name="foodrequest[]" type="text"  /> 
            <br />
            口味： 
            ...
            素食<br />
            忌口： 
            <input name="hatefood" type="text" /> 
            <br />
            有其它要求或您喜欢的餐厅可填写在个性需求里填写</td>
        </tr>
        <tr><td></td><td></td></tr>
        <tr> 
          <td valign="top"><div align="right"><strong>娱乐：</strong></div></td>
          <td valign="top" style="text-align:left"><input type="checkbox" name="recreation" />
                   期望体验当地民族风情表演</td>
        </tr>
        <tr> 
          ...
          <textarea name="specialrequest" cols="70" rows="8"></textarea></td>
        </tr>
  <!--  <tr> 
    ...
    <tr> 
        ...
        <td  style="text-align:left">验证码 <input type="text" id="verifyCode" name="verifyCode" class=" easyui-validatebox" title="验证码" data-options="required:true" nullmsg="请输入验证码!"/>
