    ...
    <td>  
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="heedline1">
        ...
        <tr> 
          ...
          <td width="65%" style="text-align:left;width:65%;"><input name="expectedDepart" id="expectedDepart" type="text" class='easyui-datebox' data-options="height:22,showSeconds:false, validType:'dateValided',editable:false,split:true,border:false,region:'north',onSelect:itour.mmhotsightselfbooking.onChangeDate(this)"/></td>
        </tr>
        <tr> 
          <td width="35%"align="right" style="text-align:right"> <strong>返程日期：</strong></td>
          <td style="text-align:left;width:65%"><input id="expectedBack" name="expectedBack" type="text" class='easyui-datebox' data-options="height:22,showSeconds:false, validType:'md[\'#expectedDepart\']',editable:false,split:true,border:false,region:'north',onSelect:itour.mmhotsightselfbooking.onChangeDate(this)"/></td>
        </tr>
        <tr> 
          ...
          <input id="groupDate" name="groupDate" type="text" class='easyui-datebox' data-options="prompt:'--出团日期--',height:22,validType:'dateValided',editable:false,split:true,border:false,region:'north',onSelect:itour.mmhotsightselfbooking.onChangeDate(this)" />
          </span> </td>
        </tr>
        <tr> 
  ...
  <!--  <tr> 
    ...
    <tr> 
        ...
        <td style="text-align:left;width:65%"> <input type="text" id="verifyCode" name="verifyCode" class="easyui-textbox" title="验证码" data-options="width:150,height:22,prompt:'请输入正确的验证码!'" />
          <img alt="点击更换" src="${basePath}RandomCodeServlet" id="validateCode" onclick="itour.mmhotsightselfbooking.changeValidateCode()">
          &nbsp;&nbsp;<br/><a href="javascript:void(0)" onclick="itour.mmhotsightselfbooking.changeValidateCode()">看不清，换一张</a></td>
