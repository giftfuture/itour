...
<div class=box><A class="imgBorder" target="_blank" style="float:left;padding-left:0">
<img style="float:left;padding-left:0" alt="landscape" src="${basePath }${photo}" border="0" /></A> 
</div>
</c:forEach>
<!-- 图片列表 end --></DIV>
 ...
 <td style="text-align:center;float:middle;"> 
     <table style="text-align:center;float:middle;" align="center">
      ...
      <tr>
        <td background="images/frame2-2.gif"><table cellspacing="0" cellpadding="0" border="0" align="center">
          ...
          <tr>
            <td><table class="STYLE126" width="100%" cellspacing="2" cellpadding="4" border="0">
              <tbody><tr>
          <td class="STYLE126" style="  "><div align="right"><strong>类型</strong></div></td>
        ...
        <tr>
          <td width=" " class="STYLE126" style=""><div align="right"><strong>线路编号</strong></div></td>
          <td width=" " class="STYLE126" style=" text-align:left">${rt.routeCode}</td>
        </tr>
        <tr>
          <td class="STYLE126" style=" "><div align="right"><strong>旅行天数</strong></div></td>
        ...
        <tr>
          <td class="STYLE126" style=" "><div align="right"><strong>最高海拔</strong></div></td>
          <td class="STYLE126" style= "text-align:left">${rt.mileage}米</td>
        </tr>
        <tr>
          <td class="STYLE126" style=" "><div align="right"><strong>起始地</strong></div></td>
          <td class="STYLE126" style= "float:left;text-align:left">${rt.departure }<a href="javascript:void(0)" title="${rt.departure}">Explain&gt;&gt;</a></td>
        </tr>
        <tr>
          <td class="STYLE126" style=" "><div align="right"><strong>完成地</strong></div></td>
          <td class="STYLE126" style=" text-align:left">${rt.arrive }</td>
        </tr>
        <tr>
          <td class="STYLE126" style=""><div align="right"><strong>路线</strong></div></td>
          <td class="STYLE126" style=" text-align:left">${rt.routeLine }</td>
        </tr>
        <tr>
          <td class="STYLE126" style=" "><div align="right"><strong>交通方式</strong></div></td>
          <td class="STYLE126" style=" text-align:left">${rt.transportation }</td>
        </tr>
        <tr>
          <td class="STYLE126" style=" "><div align="right"><strong>徒步难度</strong></div></td>
        ...
        <tr>
          <td class="STYLE126" style=""><div align="right"><strong>徒步距离 </strong></div></td>
          <td class="STYLE126" style= "float:left;text-align:left;">${rt.trekDistance }km</td>
        </tr>
        <tr>
          <td class="STYLE126" style=" "><div align="right"><strong>山峰类型</strong></div></td>
...
<div class="frametb" id="tab-container" class='tab-container' width="100%"  style="width:100%;text-align:center;float:middle" >
 <ul style="text-align:left;float:left" class='etabs'>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hiking/hiking/${alias}#review" target="_self">整体概览</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hiking/hiking/${alias}#detail-route" target="_self">详细行程</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hiking/hiking/${alias}#need-know" target="_self">行前需知</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hiking/hiking/${alias}#feed-back" target="_self">客户反馈</a></li>
 ...
 <div id="review" name="review">
  ...
  <tr>
    <td background="images/frame1-2.gif" width="100%" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr> 
  ...
  <tr>
    ...
    <td width="100%" style="text-align:left;float:left;"><span class="h2-24"><span class="STYLE148">行前需知</span></span></td>
  </tr>
   <tr>
  ...
  <tr>
    ...
    <td width="100%" style="text-align:left"><span class="h2-24"><span class="STYLE148"><span class="STYLE14"><span class="STYLE2" style="text-align:left">还想了解什么吗？快来跟我们说说：</span></span></span></span></td>
  </tr>
</table>
<table  class="frametb" align="center">
  <tr>
