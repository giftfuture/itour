...
<div class="frametb" id="tab-container" class='tab-container' width="100%"  style="width:100%;text-align:center;float:middle" >
 <ul style="text-align:left;float:left" class='etabs'>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hiking-${alias}#review" target="_self">整体概览</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hiking-${alias}#detail-route" target="_self">详细行程</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hiking-${alias}#need-know" target="_self">行前需知</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hiking-${alias}#show-happy" target="_self">回忆幸福</a></li>
