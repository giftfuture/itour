    ...
    <td>  
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="heedline1">
		...
		<tr> 
		  ...
		  <input id="groupDate" name="groupDate" type="text" class='easyui-datebox' data-options="prompt:'--出团日期--',height:22,validType:'dateValided',editable:false,split:true,border:false,region:'north',onSelect:itour.mtrekselfbooking.onChangeDate(this)" />
		  </span> </td>
        </tr>
        <tr> 
  ...
  <!--  <tr> 
    ...
    <tr> 
        ...
        <td style="text-align:left;width:65%"> <input type="text" id="verifyCode" name="verifyCode" class="easyui-textbox" title="验证码" data-options="width:150,height:22,prompt:'请输入正确的验证码!'" />
          <img alt="点击更换" src="${basePath}RandomCodeServlet" id="validateCode" onclick="itour.mtrekselfbooking.changeValidateCode()">
          &nbsp;&nbsp;<br/><a href="javascript:void(0)" onclick="itour.mtrekselfbooking.changeValidateCode()">看不清，换一张</a></td>
