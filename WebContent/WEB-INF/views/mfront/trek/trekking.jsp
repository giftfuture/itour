...
<table  class="commontb" align="center" style="width:100%">
  ...
  <tr>
    ...
    <td class="rightlinks"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="lefttxt">
        <tr> 
...
<script type="text/javascript" src="${basePath}jsm/ux/front/trek/trekking.js"></script>
