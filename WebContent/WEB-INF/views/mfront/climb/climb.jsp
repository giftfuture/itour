...
<table  class="commontb" align="center" style="width:100%">
  <!--DWLayoutTable-->
  <tr>
    <td width="10" background="image/shadowleft.gif"><img style="max-width: 100%;" src="image/shadowleft.gif" width="10" height="8" /></td>
    <td valign="top" class="title"><table width="72%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
         <td width="88%" height="40"><p class="righttxt"><strong><font size="+3">Southwest-China-Adventures.com</font> </strong></p></td>
        <td width="12%"><img style="max-width: 100%;" src="img-test/China.jpg" width="40" height="24" /><img style="max-width: 100%;" src="img-test/ok.gif" width="31" height="24" /><img style="max-width: 100%;" src="img-test/Belgium.jpg" width="32" height="24" /></td>
      </tr>
    </table></td>
    <td width="10" background="image/shadowright.gif"><img style="max-width: 100%;" src="image/shadowright.gif" width="10" height="8" /></td>
  </tr>
</table>
<table  class="commontb" align="center" style="width:100%">
  <!--DWLayoutTable-->
  <tr>
    <td width="10"><img style="max-width: 100%;" src="${basePath}images/shadowleft.gif" width="10" height="8" /></td>
    <td class="rightlinks"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="lefttxt">
        <tr> 
      ...
      <table width="960" border="0" align="center" cellpadding="0" cellspacing="10" bgcolor="#CCCCCC" class="lefttxt">
        <tr>
          <td width="600" valign="top"><img style="max-width: 100%;" src="${basePath}images/img/yading-03.jpg" width="600" height="338" /></td>
...
<span class="STYLE129">人数：</span>${item.recommandCrowd}</p>
        ...
        <tr> 
          <td width="620" valign="top"><p><br />
           ${item.item}</p>
            ...
            ${item.itinerary }</p>
            <p><br /><img style="max-width: 100%;" src="${basePath}images/img/yading-05.jpg" width="600" height="338" /></p>
            <p><img style="max-width: 100%;" src="${basePath}images/img/yading-02.jpg" width="600" height="338" /></p>
            <p><img style="max-width: 100%;" src="${basePath}images/img/yading-04.jpg" width="600" height="338" /></p>
            <p><img style="max-width: 100%;" src="${basePath}images/img/yading-01.jpg" width="600" height="338" /><br />
            </p></td>
    ...
    <img style="max-width: 100%;" src="${basePath}/images/shadowright.gif" width="10" height="8" /></td>
  </tr>
</table>
<table  class="commontb" align="center" style="width:100%">
  <!--DWLayoutTable-->
  <tr>
    ...
    <img style="max-width: 100%;" src="${basePath}images/shadowleft.gif" width="10" height="8" /></td>
