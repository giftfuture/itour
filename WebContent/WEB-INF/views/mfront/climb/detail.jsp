...
<div class="frametb" id="tab-container" class='tab-container' width="100%"  style="width:100%;text-align:center;float:middle" >
 ...
 <ul style="text-align:left;float:left" class='etabs'>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}climb-${alias}#review" target="_self">整体概览</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}climb-${alias}#detail-route" target="_self">详细行程</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}climb-${alias}#need-know" target="_self">行前需知</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}climb-${alias}#show-happy" target="_self">回忆幸福</a></li>
 ...
 <div id="review" name="review">
  ...
  <table  class="frametb" align="center">
  <tr>
    <td  colspan=2 width="32" style="text-align:left;float:left;padding-top:30;"><img src="images/document2.png" width="32" height="32" /> 
          ...
          <td width="31%" valign="top"><table width="357" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
              ...
              <tr>
                ...
                <td width="249" bgcolor="#F0F0F0" class="STYLE126" style="padding-left:20px;text-align:left;height:22"><input type="text" name="name"  class="easyui-textbox" data-options="height:22,prompt:'请键入您的大名',validType:'string'"/><!--  -->
                    <select name="sex" id="sex" class="easyui-combobox" data-options="width:60,editable:false,panelHeight:80,height:22">
