...
<div class="frametb" id="tab-container" class='tab-container' width="100%"  style="width:100%;text-align:center;float:middle" >
 ...
 <ul style="text-align:left;float:left" class='etabs'>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}climb-climb-${alias}#review" target="_self">整体概览</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}climb-climb-${alias}#detail-route" target="_self">详细行程</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}climb-climb-${alias}#need-know" target="_self">行前需知</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}climb-climb-${alias}#feed-back" target="_self">客户反馈</a></li>
 ...
 <div id="review" name="review">
  ...
  <tr>
     <td  colspan=2 ><span style="text-align:left;float:left" class="STYLE3">告诉我们您的需求，免费为您策划方案 GO! </span>&nbsp;&nbsp; 
