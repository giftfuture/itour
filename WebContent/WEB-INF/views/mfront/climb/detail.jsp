...
<div class="frametb" id="tab-container" class='tab-container' width="100%"  style="width:100%;text-align:center;float:middle" >
 ...
 <div id="review" name="review">
  ...
  <tr>
    <td width="100%" style="align:left;float:left"><img   src="${basePath}images/frame1-1.gif" width="1140" height="7" /></td>
  </tr>
  <tr>
    <td background="${basePath}images/frame1-2.gif" width="100%"><table  width="100%" border="0" align="center" cellpadding="10" cellspacing="0">
      <tr>
