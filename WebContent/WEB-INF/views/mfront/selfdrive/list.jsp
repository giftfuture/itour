...
<table  class="commontb" align="center" style="width:100%">
  <tr>
    ...
    <td valign="top" class="title"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
...
<table  class="commontb" align="center">
  ...
  <tr>
    ...
    <td class="rightlinks"><table width="960" border="0" align="center" cellpadding="0" cellspacing="0" class="lefttxt">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="10" bgcolor="#CCCCCC" class="lefttxt">
        <tr>
          <td width="52%" valign="top"><img src="${basePath}images/img/yading-03.jpg" width="52%" height="338" /></td>
          <td width="48%" valign="middle"><p class="STYLE126"><span class="STYLE129"></span><br />
...
<span class="STYLE129">人数：</span>${item.recommandCrowd}</p>
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="10" class="lefttxt">
        <tr> 
          <td width="67%" valign="top"><p><br />
           ${item.item}</p>
            <p>${item.content } </p>
            <p><span class="right">行程 ：</span><br />
            ${item.itinerary }</p>
            <p><br /><img src="${basePath}images/img/yading-05.jpg" width="67%" height="338" /></p>
            <p><img src="${basePath}images/img/yading-02.jpg" width="67%" height="338" /></p>
            <p><img src="${basePath}images/img/yading-04.jpg" width="6067%0" height="338" /></p>
            <p><img src="${basePath}images/img/yading-01.jpg" width="67%" height="338" /><br />
            </p></td>
...
<script type="text/javascript" src="${basePath}jsm/ux/front/selfdrive/list.js"></script>
