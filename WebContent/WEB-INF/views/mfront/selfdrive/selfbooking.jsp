    ...
    <td>  
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="heedline1">
        ...
        <tr> 
          ...
          <td width="65%" style="text-align:left;width:65%;"><input name="expectedDepart" id="expectedDepart" type="text" class='easyui-datetimebox' data-options="height:22,showSeconds:false, validType:'dateValided',editable:false,split:true,border:false,region:'north',onSelect:itour.mselfdriveselfbooking.onChangeDate(this)"/></td>
        </tr>
        <tr> 
          <td width="35%"align="right" style="text-align:right"> <strong>返程日期：</strong></td>
          <td style="text-align:left;width:65%"><input id="expectedBack" name="expectedBack" type="text" class='easyui-datetimebox' data-options="height:22,showSeconds:false, validType:'md[\'#expectedDepart\']',editable:false,split:true,border:false,region:'north',onSelect:itour.mselfdriveselfbooking.onChangeDate(this)"/></td>
        </tr>
        <tr> 
