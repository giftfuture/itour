     		 ...
     		 <div class="ui-edit">
				...
				<!-- 	<div class="fitem">
				   ...
				   <div class="fitem">
					...
					<div class="fitem">
						<label>出行日期:</label>
						<input id="groupDate" name="groupDate" type="text" class='easyui-datebox' data-options="validType:'dateValided',editable:false,split:true,border:false,region:'north',width:134" />
					</div>
					<!-- <div class="fitem">
						<label>创建时间:</label>
