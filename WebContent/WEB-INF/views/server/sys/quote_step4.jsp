...
<table class="commontb" align="center">
  <tr>
    <td style="float:left" class="h1-black" >${bean.title}<input type="hidden" name="idrt" value="${rt.routeCode}"></td>
  </tr>
  <tr>
    <td>
    <table>
...
<!--滚动图片 end-->
    ...
    <td style="float:left" valign="top"><div align="center"><span class="STYLE2">这条线路适合我吗？</span>
      ...
      <table >
        <tr>
          ...
          <td class="STYLE126" style="margin-left:10px;padding-left:10px;text-align:left"><strong>${bean.travelStyle} </strong><a href="javascript:void(0)" title="${bean.travelStyle}">Explain&gt;&gt;</a></td>
        </tr>
        <tr>
          ...
          <td width="350" class="STYLE126" style="margin-left:10px;text-align:left">${bean.routeCode}</td>
        </tr>
        <tr>
          <td class="STYLE126" style="margin-right:10px;padding-right:10px;"><div align="right"><strong>旅行天数</strong></div></td>
          <td class="STYLE126" style="margin-left:10px;text-align:left">${bean.rcdDays}天<strong> </strong><a href="javascript:void(0)" title="${bean.rcdDays}">Explain&gt;&gt;</a></td>
        </tr>
        <tr>
          <td class="STYLE126" style="margin-right:10px;padding-right:10px;"><div align="right"><strong>最高海拔</strong></div></td>
          <td class="STYLE126" style="margin-left:10px;text-align:left">${bean.mileage}米</td>
        </tr>
        <tr>
          <td class="STYLE126" style="margin-right:10px;padding-right:10px;"><div align="right"><strong>起始地</strong></div></td>
          <td class="STYLE126" style="margin-left:10px;text-align:left">${bean.departure }<a href="javascript:void(0)" title="${bean.departure}">Explain&gt;&gt;</a></td>
        </tr>
        <tr>
          <td class="STYLE126" style="margin-right:10px;padding-right:10px;"><div align="right"><strong>完成地</strong></div></td>
          <td class="STYLE126" style="margin-left:10px;text-align:left">${bean.arrive }</td>
        </tr>
        <tr>
          <td class="STYLE126" style="margin-right:10px;padding-right:10px;"><div align="right"><strong>路线</strong></div></td>
          <td class="STYLE126" style="margin-left:10px;text-align:left">${bean.routeLine }</td>
        </tr>
        <tr>
          <td class="STYLE126" style="margin-right:10px;padding-right:10px;"><div align="right"><strong>交通方式</strong></div></td>
          <td class="STYLE126" style="margin-left:10px;text-align:left">${bean.transportation }</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="STYLE126" style="margin-left:10px;text-align:left">${bean.trekDistance }km</td>
        </tr>
        <tr>
          <td class="STYLE126" style="margin-right:10px;padding-right:10px;"><div align="right"><strong>山峰类型</strong></div></td>
          <td class="STYLE126" style="margin-left:10px;text-align:left">${bean.mountStyle } <a href="javascript:void(0)" title="${bean.mountStyle}">Explain&gt;&gt; </a></td>
        </tr>
      </table>
    ...
    <table class="f12-gao1">
 	 ...
 	 <tr><td>相关路线：
      <c:forEach items="${bean.relates}" var="relat"><br>
      <a href="${basePath}${bean.travelStyle }/${bean.travelStyle }/${relat.alias}" >${relat.title }</a>
      </c:forEach>
      </td></tr>
    </table></td>
  </tr>
        ...
        <tr>
          ...
          <table width="1100" border="0" align="center" cellpadding="4" cellspacing="2">
            ...
            <tr>
              ...
              <td>大人：<span name="adultsperguy">${calvo.plusSumPrice+adultsumcost }</span>元/人*${od.adults }人<br />
            ...
            <tr>
              ...
              <td><label></label>
                  ...
                  <table border="0" cellspacing="0" cellpadding="3">
                    <tr>
                      <td><a style="padding-left:20px;margin-left:20px;" href="travelOrder/returntoQuote3/${torder.id}/${bean.id }" class="easyui-linkbutton" iconcls="icon-back" >返回上页修改</a></td>
                      <td><input type="button" name="modefyProject" value="改下项目描述" /></td>
                      <td><input type="submit" name="generateReport" value="生成正式报价单" /></td>
                    </tr>
                </table></td>
              <td>&nbsp;</td>
            </tr>
