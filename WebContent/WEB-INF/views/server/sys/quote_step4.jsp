...
<!--滚动图片 end-->
    ...
    <table class="f12-gao1">
      <tr>
        ...
        <a id="copyurl" data-clipboard-target="flashcopier">复制链接</a><div style="display:none" id="flashcopier"></div></td>
...
<div  style="width:1350px;text-align:center;align:center;font-family: '微软雅黑';border:0;"  id="tab-container" class='tab-container' cellpadding="3" cellspacing="1">
 <ul style="text-align:left;float:left" class='etabs'>
   ...
   <li width="110" bgcolor="#F0F0F0" class='tab'><a target="_self">行前需知</a></li>
 </ul>
 ...
 <div id="review" name="review">
  ...
  <tr>
    ...
    <span class="h2-24" style="float:left"><span class="STYLE148" style="color: #990000;font-family: '微软雅黑';font-size: 24px;">简要日程</span></span></td>
  </tr>
   <tr>
  ...
  <tr>
    ...
    <td width="1028" style="text-align:left"><span class="h2-24"><span class="STYLE148" style="color: #990000;font-family: '微软雅黑';font-size: 24px;float:left">行前需知</span></span></td>
  </tr>
   <tr>
