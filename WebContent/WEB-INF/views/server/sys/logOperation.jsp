...
<html>
  ...
  <body class="easyui-layout">
 	 ...
 	 <form id="searchForm">
        <p class="ui-fields">
			<label class="ui-label">操作码:</label><input name="operCode" class="easyui-box ui-text" style="width:100px;">
			<label class="ui-label">日志码:</label><input name="logCode" class="easyui-box ui-text" style="width:100px;">
			<label class="ui-label">操作类型:</label><input name="operationType" class="easyui-box ui-text" style="width:100px;">
	    </p>
