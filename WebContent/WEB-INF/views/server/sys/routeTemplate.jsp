...
<html>
  ...
  <body class="easyui-layout">
 	 ...
 	 <form id="searchForm">
        <p class="ui-fields">
			<label class="ui-label">旅行方式:</label><input name="travelStyle" id="travelStyle" class="easyui-combobox" data-options="width:120,minWidth:80,height:22,valueField:'alias',textField:'type',mode:'remote',panelHeight:'150',editable:false,method:'get',url:'${basePath}travelStyle/loadStyles',prompt:'-所有-'">&nbsp;&nbsp;
			...
			<label class="ui-label">线路名称:</label><input name="routeName" class="easyui-textbox"  data-options="width:120">&nbsp;&nbsp;
	    </p> &nbsp;&nbsp;
