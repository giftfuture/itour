     	...
     	<form id="editForm" class="ui-form" method="post">  
     		 ...
     		 <div class="ui-edit">
				...
				<!-- 	<div class="fitem">
					...
					<div class="fitem">
						<label>晒出人</label>
						<input name="title" type="text" maxlength="255" required="true" class="easyui-validatebox" data-options="" missingMessage="请填写晒出人">
						<span style="color:red">*</span>
					</div>
					<div class="fitem">
						<label>来自地区</label>
						<input name="area" type="text" maxlength="255" required="true" class="easyui-validatebox" data-options="" missingMessage="请填写来自地区">
						<span style="color:red">*</span>
					</div>
					<div class="fitem">
						<label>路线</label>
						<input name="route" type="text" maxlength="255" required="true" class="easyui-validatebox" data-options="" missingMessage="请填写路线图">
						<span style="color:red">*</span>
					</div>
					<div class="fitem">
						<label>审核状态</label>
