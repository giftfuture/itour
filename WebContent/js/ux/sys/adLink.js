	   			...
	   			columns:[[
					...
					{field:'adlink',title:'链接地址',align:'left',sortable:true,width:'400',
						...
						{field:'advertise',title:'链接图片',align:'center',sortable:true,width:'300',
							formatter:function(value,row,index){
								return '<a href="javascript:void(0)" onmouseenter="javascript:itour.adLink.previewphoto(\''+row.advertise+'\',\''+row.title+'\' )" onmouseleave="javascript:itour.adLink.unpreviewphoto()">预览</a>';
							}
						},
