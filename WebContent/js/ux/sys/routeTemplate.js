...
itour.routeTemplate = function(){
	...
	config:{
		...
		action:{
			...
			/*		{field:'customerId',title:'客户ID',align:'center',sortable:true,
					...
					{field:'cover',title:'封面',align:'center',sortable:true,
						formatter:function(value,row,index){
							return '<a href="javascript:void(0)" onmouseenter="javascript:itour.routeTemplate.previewcover(\''+row.cover+'\',\''+row.title+'\' )" onmouseleave="javascript:itour.routeTemplate.unpreviewcover()">预览</a>';
						}
					},
					{field:'viewphotos',title:'美图',align:'center',sortable:true,
						formatter:function(value,row,index){
							return '<a href="javascript:void(0)" onmouseenter="javascript:itour.routeTemplate.previewphotos(\''+row.viewphotos+'\',\''+row.viewphotoPath+'\',\''+row.routeCode+'\',\''+row.alias+'\',\''+row.title+'\')" onmouseleave="javascript:itour.routeTemplate.unpreviewphotos()">预览</a>';
						}
					},
				...
				/*	{field:'similars',title:'相似线路',align:'center',sortable:true,
					...
					{field:'routeMap',title:'路线地图',align:'center',sortable:true,
						formatter:function(value,row,index){
							return '<a href="javascript:void(0)" onmouseenter="javascript:itour.routeTemplate.previewmap(\''+row.routeMap+'\',\''+row.title+'\' )" onmouseleave="javascript:itour.routeTemplate.unpreviewmap()">预览</a>';
						}
					},
		...
		previewphotos:function(viewphotos,viewphotoPath,routeCode,alias,title){
			...
			$("#preview-photo").hover(function(){$("#preview-photos").dialog('open');},function(){
