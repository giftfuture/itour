...
(function($) {
				...
				.droppable(
						{
							...
							onDragLeave : function(e, _21) {
								$(_21).draggable("proxy").removeClass(
							...
							onDrop : function(e, _22) {
								...
								if ($(this).hasClass("tree-node-append")) {
									...
									_24 = _27;
									_25 = $(this).hasClass("tree-node-top") ? "top"
											: "bottom";
								}
								_24(_22, _23, _25);
								$(this)
	...
	function _4a(_4b, ul, _4c, _4d) {
		...
		var _4f = [];
		var _50 = $(ul).prev("div.tree-node").find(
	...
	function _59(_5a, ul, _5b) {
		...
		if (!_5b) {
			_5b = true;
			$(_5a).find("span.tree-indent").removeClass(
					"tree-line tree-join tree-joinbottom");
			$(_5a).find("div.tree-node").removeClass(
		...
		var _61 = $(ul).children("li:last").children("div.tree-node").addClass(
				"tree-node-last");
		_61.children("span.tree-join").removeClass("tree-join").addClass(
				"tree-joinbottom");
		...
		function _5f(_65) {
			...
			_65.next().find("div.tree-node").each(
					function() {
	...
	function _ae(_af, _b0) {
		...
		if (ul.children("li").length == 0) {
			var _b2 = ul.prev();
			_b2.find(".tree-icon").removeClass("tree-folder").addClass(
					"tree-file");
	...
	function _14(_c0, _c1) {
		...
		if (!_45(_c0, _c1)) {
			_c2.state = $(_c1).find(".tree-hit").hasClass("tree-expanded") ? "open"
					: "closed";
		}
		return _c2;
	}
