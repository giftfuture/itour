			  	...
			  	$.post(basePath+"searchRtResult",{'pageNo':pageno,'travel_style':travel_style,'vacation':vacation,'level1Area':level1Area,'level2Area':level2Area},
						function(responseText){
								...
								$(searchRts).each(function(i,e){
						            ...
						            "</tr>"+
						            "<tr>"+
						              "<td><a href='"+basePath+(e.travelStyleAlias?e.travelStyleAlias:"")+"/"+(e.travelStyleAlias?e.travelStyleAlias:"")+"/"+(e.alias?e.alias:"")+"'><img src='"+basePath+""+(e.cover?e.cover:"")+"' width='100%' /></a></td>"+
						            "</tr>"+
						            "<tr>"+
						              "<td class='STYLE8'>"+
