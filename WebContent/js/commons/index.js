...
itour.index = function(){
	var _this = {
		...
		changeImg:function (curIndex,arr,titles,links,bannerindex){
		  ...
		  //  $("a").removeClass('btn-item__cur');
		    ...
		    $(bannerindex).parents("tr").next().find("li").eq(curIndex).addClass('btn-item__cur');
		...
		init:function(){
			...
			//var intervalid =
			setInterval(_this.changeImg(parseInt(curIndex),arr,titles,links,bannerindex),timeInterval);
			...
			$(bannerindex).parents("tr").next().find("li").each(function(i,e){
				$(this).click(function(){	
		   			...
		   			//intervalid =
	   				setInterval(_this.changeImg(i,arr,titles,links,bannerindex),timeInterval);
