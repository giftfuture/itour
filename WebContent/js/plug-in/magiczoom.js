...
MagicZoom.prototype.initZoom = function() {
    ...
    case 'left':
        this.bigImageCont.style.left = '-' + (20 + parseInt(this.bigImageCont.style.width)) + 'px';
        break;
    case 'bottom':
        ...
        break;
    case 'top':
        this.bigImageCont.style.top = '-' + (20 + parseInt(this.bigImageCont.style.height)) + 'px';
        this.bigImageCont.style.left = '0px';
        break;
    case 'custom':
        this.bigImageCont.style.left = '0px';
...
function MagicZoom_findZooms() {
    ...
    for (var i = 0; i < aels.length; i++) {
        if (/MagicZoom/.test(aels[i].className)) {
            ...
            aels[i].style.outline = '0';
            aels[i].style.width = '30px';
            aels[i].style.height = '30px';
