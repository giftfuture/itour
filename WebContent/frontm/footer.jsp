...
<table class="commontb" align="center"  width="100%"  height="100%" style="width:100%;height:150px;"  data-role="content"  data-fullscreen="true">
  <tr>
    ...
    <td width="75%" bgcolor="#CCCCCC" class="f14-gao1" >  
       <p style="height:15px"><span style="text-align:left"><strong>旅行方式：</strong>&nbsp;<input name="travel_style" id="travel_style" class="easyui-combobox" value="${travelStyle}" data-options="width:120,minWidth:50,height:22,valueField:'alias',textField:'type',mode:'remote',panelHeight:'300',editable:false,method:'get',url:'${basePath}travelStyle/loadStyles'"/></span></p>
      <p style="height:15px"><span style="text-align:left">
       <strong>旅游区域： </strong>
         ...
         <p style="height:15px"><span><strong style="display:none;">旅游区域：</strong><input id="level2Area" name="level2Area" class="easyui-combobox" data-options="width:120,minWidth:50,height:22,panelHeight:'auto',editable:false"/></span> 
         </p>
