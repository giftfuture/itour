...
<table class="commontb" align="center"  width="100%" style="width:100%"  data-role="content"  data-fullscreen="true">
  <tr>
    ...
    <td width="75%" bgcolor="#CCCCCC" class="f14-gao1" >  
       <p style="height:15px"><span style="text-align:left"><strong>旅行方式：</strong>&nbsp;<input name="travel_style" id="travel_style" class="easyui-combobox" value="${travelStyle}" data-options="height:20,valueField:'alias',textField:'type',mode:'remote',panelHeight:'300',editable:false,method:'get',url:'${basePath}travelStyle/loadStyles'"/></span></p>
