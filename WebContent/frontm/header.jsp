...
<center><div id="top-menu" data-role="content" data-fullscreen="true">
    <table align="center" style="border:0;cursor:pointer;width:100%" > <!-- class="easyui-datagrid" -->
    	...
    	<tr><th colspan=7><span style="color:red">一鍵撥號：<a >+86&nbsp;28&nbsp;85580038</a></span>&nbsp;&nbsp;&nbsp;<!-- <a href="sms:139xxxxxxx">一键发送短信</a> --> 
    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://zjj.itours.com.cn/itour_en">英文</a></th></tr>
    	...
    	<td style="text-align:center;width:15%"><a onclick="location.href='${basePath }light/main'">輕驢行</a></td>
    	<%-- <td><a href="${basePath }customized/main">定制</a></td> --%>
    	<td style="text-align:center;width:15%"><a onclick="location.href='${basePath }showhappy/main'">回憶興福</a></td>
    	<td style="text-align:center;width:15%"><a onclick="location.href='${basePath }destination/main'">目的地</a></td>
